...
/**
 * @extends ServiceEntityRepository<Machin>
 *
...
class MachinRepository extends ServiceEntityRepository
{
    ...
    public function save(Machin $entity, bool $flush = false): void
    {
    ...
    public function remove(Machin $entity, bool $flush = false): void
    {
